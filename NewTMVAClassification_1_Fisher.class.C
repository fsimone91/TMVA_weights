...
{
   fFisher0 = -0.30272465534;
   fFisherCoefficients.push_back( -0.00257865333357 );
   fFisherCoefficients.push_back( -0.749000759341 );
   fFisherCoefficients.push_back( 0.0228410275695 );
   fFisherCoefficients.push_back( -0.000193802526936 );
   fFisherCoefficients.push_back( 0.373910058704 );
   fFisherCoefficients.push_back( 0.0817061313075 );
   fFisherCoefficients.push_back( -0.00640161076949 );
   fFisherCoefficients.push_back( 0.249259658468 );
