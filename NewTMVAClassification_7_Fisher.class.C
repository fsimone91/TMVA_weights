...
{
   fFisher0 = -0.38965784495;
   fFisherCoefficients.push_back( -0.00358881036578 );
   fFisherCoefficients.push_back( -1.78691964314 );
   fFisherCoefficients.push_back( 0.0249575584754 );
   fFisherCoefficients.push_back( -0.000355161225532 );
   fFisherCoefficients.push_back( 0.574605839116 );
   fFisherCoefficients.push_back( 0.0999431549599 );
   fFisherCoefficients.push_back( -0.00947463550935 );
   fFisherCoefficients.push_back( 0.427514752801 );
