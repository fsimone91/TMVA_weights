...
{
   fFisher0 = -0.596239326598;
   fFisherCoefficients.push_back( -0.00596474529458 );
   fFisherCoefficients.push_back( -2.34900605883 );
   fFisherCoefficients.push_back( 0.0697320144074 );
   fFisherCoefficients.push_back( -0.000451832500805 );
   fFisherCoefficients.push_back( 0.614282782739 );
   fFisherCoefficients.push_back( 0.210327626521 );
   fFisherCoefficients.push_back( -0.0100489631067 );
   fFisherCoefficients.push_back( -0.12084037706 );
