...
{
   fFisher0 = -0.593574589356;
   fFisherCoefficients.push_back( -0.00557822843641 );
   fFisherCoefficients.push_back( -1.12071832913 );
   fFisherCoefficients.push_back( 0.0731067001377 );
   fFisherCoefficients.push_back( -0.000312100248246 );
   fFisherCoefficients.push_back( 0.531543844452 );
   fFisherCoefficients.push_back( 0.255085866422 );
   fFisherCoefficients.push_back( -0.00863769630225 );
   fFisherCoefficients.push_back( -0.207751747472 );
