...
{
   fFisher0 = -0.477502402859;
   fFisherCoefficients.push_back( -0.00550222539446 );
   fFisherCoefficients.push_back( -2.17165549971 );
   fFisherCoefficients.push_back( 0.0555143911258 );
   fFisherCoefficients.push_back( -0.000402753985648 );
   fFisherCoefficients.push_back( 0.510596835813 );
   fFisherCoefficients.push_back( 0.181710761464 );
   fFisherCoefficients.push_back( -0.00788669897774 );
   fFisherCoefficients.push_back( -0.113275781123 );
