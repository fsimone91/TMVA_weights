...
{
   fFisher0 = -0.448252611543;
   fFisherCoefficients.push_back( -0.00410138209384 );
   fFisherCoefficients.push_back( -1.6520860453 );
   fFisherCoefficients.push_back( 0.0505328071823 );
   fFisherCoefficients.push_back( -0.000338026728711 );
   fFisherCoefficients.push_back( 0.434733473624 );
   fFisherCoefficients.push_back( 0.166446695831 );
   fFisherCoefficients.push_back( -0.00532815601998 );
   fFisherCoefficients.push_back( -0.052018552334 );
