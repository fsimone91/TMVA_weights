...
void BDT_optimal_cut() 
{
    ...
    for(int k=0; k<3; k++)
    {
	    ...
	    h_test_signal = (TH1F*)f->Get("dataset/Method_BDT/BDT/MVA_BDT_S_high");
	    h_test_bkg = (TH1F*)f->Get("dataset/Method_BDT/BDT/MVA_BDT_B_high");
