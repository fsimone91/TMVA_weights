...
{
   fFisher0 = -0.716138016713;
   fFisherCoefficients.push_back( -0.00697129013785 );
   fFisherCoefficients.push_back( -2.07760694141 );
   fFisherCoefficients.push_back( 0.090533680038 );
   fFisherCoefficients.push_back( -0.000352870463871 );
   fFisherCoefficients.push_back( 0.634521778011 );
   fFisherCoefficients.push_back( 0.33004229863 );
   fFisherCoefficients.push_back( -0.0100093655809 );
   fFisherCoefficients.push_back( -0.260797232395 );
