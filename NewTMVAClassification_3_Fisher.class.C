...
{
   fFisher0 = -0.488495618572;
   fFisherCoefficients.push_back( -0.00435044129903 );
   fFisherCoefficients.push_back( -2.06223024632 );
   fFisherCoefficients.push_back( 0.0665686460304 );
   fFisherCoefficients.push_back( -0.000286458655916 );
   fFisherCoefficients.push_back( 0.410365943395 );
   fFisherCoefficients.push_back( 0.221673090534 );
   fFisherCoefficients.push_back( -0.00668604185221 );
   fFisherCoefficients.push_back( -0.151273632418 );
